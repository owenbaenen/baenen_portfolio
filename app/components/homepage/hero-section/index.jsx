    ...
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-8">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="flex flex-col items-start justify-center p-2 pb-10 md:pb-6 lg:pt-0">
          <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-[2.2rem] font-bold leading-snug text-white md:font-extrabold lg:leading-[3rem]">
            Welcome, <br />
            ...
            <span className="text-amber-400">{personalData.designation}</span>
          </h1>
